...
//First Button
function first(){
	if(location.href==="../../DTIS-home.html"){
	document.getElementById("first").disabled = true;
}
	else{
		location.href="../../DTIS-home.html";
		document.getElementById("first").disabled = false;
	}
}
//Next Button
...
else if(location.href==="../../DTIS-home.html"){
location.href="./A1/Site/DTIS-02.html"; 
		}
//more than 10
 else{
location.href=(nSecondLink+(pageNum+1)+nEndLink);
}
}
//Previous Button
function previous(){
